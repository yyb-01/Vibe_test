...
| 콘솔 영속 저장 연결 | 완료 | 재시작 요청 순번 복구·128bit ID 입출력·Pending 재확인·quit/EOF 종료·백업 3개; `scripts/test-demo.ps1` |
