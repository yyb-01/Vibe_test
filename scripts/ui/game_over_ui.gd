...
@onready var return_btn: Button = $CenterContainer/VBoxContainer/ButtonRow/ReturnButton
@onready var retry_btn: Button = $CenterContainer/VBoxContainer/ButtonRow/RetryButton
...
func _on_return_pressed() -> void:
	...
	if is_instance_valid(menu_scene):
		var err := get_tree().change_scene_to_packed(menu_scene)
		if err != OK:
...
func _on_retry_pressed() -> void:
	...
	if is_instance_valid(map_scene):
		var err := get_tree().change_scene_to_packed(map_scene)
		if err != OK:
